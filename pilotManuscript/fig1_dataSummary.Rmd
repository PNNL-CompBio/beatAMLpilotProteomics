...
mpp<-combined%>%
  ...
  ggplot(aes(x=mRNALevels,y=proteinLevels,col=`AML sample`,shape=as.factor(binaryMutations)))+geom_point()+scale_color_viridis_d()+ggtitle('mRNA/Protein correlation')
