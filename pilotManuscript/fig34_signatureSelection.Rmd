...
<<<<<<< Updated upstream:pilotManuscript/fig23_signaturePlots.Rmd
tr.dat<- pat.data%>%
...
if(file.exists('combinedPreds.rds')){
...
>>>>>>> Stashed changes:pilotManuscript/fig34_signatureSelection.Rmd
...
<<<<<<< Updated upstream:pilotManuscript/fig23_signaturePlots.Rmd
Given the diversity of signatures otbtained from the predictive models, we use the signatures from the complete models and the performance from K-means validation to identify specific gene signatures. 
=======
