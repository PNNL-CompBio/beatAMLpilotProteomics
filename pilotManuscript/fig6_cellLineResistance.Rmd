...
ph.genelist<-getFeaturesFromString(subset(tram.preds,Molecular=='Phosphosite')$genes,'Phosphosite')
pr.genelist<-getFeaturesFromString(subset(tram.preds,Molecular=='proteinLevels')$genes,'proteinLevels')
...
quiz.preds%>%
  subset(method=='LASSO')%>%
  select(genes,Molecular)
ph.genelist<-getFeaturesFromString(subset(quiz.preds,Molecular=='Phosphosite')$genes,'Phosphosite')
pr.genelist<-getFeaturesFromString(subset(quiz.preds,Molecular=='proteinLevels')$genes,'proteinLevels')
