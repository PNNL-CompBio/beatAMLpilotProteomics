...
res<-lapply(folds,function(testpats){
 ...
 print("Phospho preds first")
  ...
  reg.preds<-purrr::map_df(list(mRNA='mRNALevels',
                         ...
                         ~ drugMolRegressionEval(auc.dat.fam,
                            tr.dat,
    .x,
                                                    dplyr::rename(auc.dat.fam,Sample='AML sample'),
                                               dplyr::rename(te.dat,Sample='AML sample'),
  ...
  enet.reg.preds<-purrr::map_df(list(mRNA='mRNALevels',
                              protein='proteinLevels',
                            #  gene='geneMutations',
                               binGene='binaryMutations'),
                         ~ drugMolRegressionEval(auc.dat.fam,
  ...
  e.results<-rbind(phospho.enet.results,enet.reg.preds)%>%
...
#  saveRDS(full.results,'mostlyCompletePredictions.rds')
  return(rbind(full.results,lr.results,e.results))
})
